...
One CRFS WAVE capture checked in a local folder:

- RIFF/WAVE, PCM (`wFormatTag` = 1), **2 channels**, **16-bit**, little-endian (WAVE default)
- Sample rate **62500000 Hz** (not equal to a 10 or 12.5 MHz RF bandwidth)
...
8. Default HTTP vs HTTPS port and whether EMP Basic Auth shares Node webpage credentials.
