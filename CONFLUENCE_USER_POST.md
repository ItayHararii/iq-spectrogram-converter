...
![Example spectrum and spectrogram from a stereo IQ WAV](assets/examples/example_spectrum_spectrogram_081608.png)

## Accuracy notes

- 0 dBFS is a full-scale complex IQ tone with `|a| = 1` (WAV samples in the range -1.0 to +1.0).
- True RBW is Blackman-Harris ENBW x bin width.
